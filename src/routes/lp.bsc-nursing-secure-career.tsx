...
export const Route = createFileRoute("/lp/bsc-nursing-secure-career")({
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "BSc Nursing for girls, safe nursing college Bangalore, supervised hostel nursing, RGUHS BSc Nursing, secure nursing career" },
      ...
      { property: "og:url", content: "https://cura-ready-nurses.lovable.app/lp/bsc-nursing-secure-career" },
      ...
      { name: "twitter:title", content: "BSc Nursing — A Secure Career for Your Daughter" },
      { name: "twitter:description", content: "RGUHS degree, safe hostel, hospital-integrated training and a globally-mobile career." },
    ...
    links: [{ rel: "canonical", href: "https://cura-ready-nurses.lovable.app/lp/bsc-nursing-secure-career" }],
  }),
  component: SecureLP,
});
