...
export const Route = createFileRoute("/lp/bsc-nursing-direct")({
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "BSc Nursing admission 2026, RGUHS nursing, nursing college Bangalore, Cura Institutions BSc Nursing, nursing direct admission" },
      ...
      { property: "og:url", content: "https://cura-ready-nurses.lovable.app/lp/bsc-nursing-direct" },
      ...
      { name: "twitter:title", content: "BSc Nursing Admission 2026 — Cura Institutions" },
      { name: "twitter:description", content: "Apply for 2026 intake. RGUHS BSc Nursing with hospital-integrated training." },
    ...
    links: [{ rel: "canonical", href: "https://cura-ready-nurses.lovable.app/lp/bsc-nursing-direct" }],
  }),
  component: DirectLP,
});
