...
export const Route = createFileRoute("/lp/bsc-nursing-neet-alternative")({
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "NEET alternative, NEET backup plan, BSc Nursing without NEET, MBBS vs BSc Nursing, RGUHS nursing Bangalore" },
      ...
      { property: "og:url", content: "https://cura-ready-nurses.lovable.app/lp/bsc-nursing-neet-alternative" },
      ...
      { name: "twitter:title", content: "NEET Backup — BSc Nursing at Cura Institutions" },
      { name: "twitter:description", content: "A white-coat career without NEET. RGUHS BSc Nursing with hospital training from day one." },
    ...
    links: [{ rel: "canonical", href: "https://cura-ready-nurses.lovable.app/lp/bsc-nursing-neet-alternative" }],
  }),
  component: NeetLP,
});
