...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "RGUHS-affiliated nursing & allied health sciences college in Hebbal, Bangalore. BSc Nursing, MIT, AOTT, Cardiac Care, Radiotherapy, ETCT, MLT and BPT — trained inside the Cura Hospitals network." },
      ...
      { property: "og:description", content: "RGUHS-affiliated nursing & allied health sciences college in Hebbal, Bangalore. BSc Nursing, MIT, AOTT, Cardiac Care, Radiotherapy, ETCT, MLT and BPT — trained inside the Cura Hospitals network." },
      { name: "twitter:description", content: "RGUHS-affiliated nursing & allied health sciences college in Hebbal, Bangalore. BSc Nursing, MIT, AOTT, Cardiac Care, Radiotherapy, ETCT, MLT and BPT — trained inside the Cura Hospitals network." },
