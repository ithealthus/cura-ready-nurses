    ...
    >
      ...
      <div className={`mt-5 grid gap-4 ${compact ? "" : "sm:grid-cols-2"}`}>
        <div className="space-y-1.5">
          ...
          <Input id="fn" required placeholder="Your first name" />
        </div>
        <div className="space-y-1.5">
          <Label htmlFor="ln">Last Name</Label>
          <Input id="ln" required placeholder="Your last name" />
        </div>
        <div className="space-y-1.5">
          <Label htmlFor="ph">Phone</Label>
          <Input id="ph" required type="tel" placeholder="+91" />
        </div>
        <div className="space-y-1.5">
          <Label htmlFor="em">Email</Label>
          <Input id="em" required type="email" placeholder="you@example.com" />
        </div>
        ...
        <div className={`space-y-1.5 ${compact ? "" : "sm:col-span-2"}`}>
          ...
          <Textarea id="msg" placeholder="Anything we should know?" rows={3} />
        </div>
      </div>
      <Button type="submit" size="lg" className="mt-5 w-full bg-secondary text-secondary-foreground hover:bg-secondary/90">
        Request Callback
      </Button>
    </form>
  );
